			...
			<div className="mx-auto space-y-12 font-sans">
				<header className="space-y-2">
					...
					<p className="text-muted-foreground">
						Use our API to access the full collection of logos for your
						projects.
					</p>
				</header>
				...
				<section className="space-y-4">
					...
					<p className="text-muted-foreground">
						The Nigerian Bank Logos (NBL) API provides RESTful access to a
						comprehensive collection of brand logos from the Nigerian financial
						sector, including banks, fintech, and other financial institutions.
					</p>
					<h3 className="pt-2 text-lg font-semibold">Usage Guidelines</h3>
					<p className="text-muted-foreground">
						The API is public and does not require authentication. To ensure
						fair usage and prevent abuse, we have implemented rate limiting on
						requests.
					</p>
					<Alert variant="warning">
						<AlertTriangle className="h-4 w-4" />
						<AlertDescription>
							Please do not use this API to replicate the core functionality of
							this project. It is intended for building extensions, plugins, and
							other creative tools for the community.
						</AlertDescription>
					</Alert>
				</section>
				...
				<section className="space-y-4">
					...
					<p className="text-muted-foreground">
						The following interfaces describe the structure of logo and category
