...
const IconLogo = ({ title = 'Icon Logo', titleId = 'IconLogo', ...props }: SVGIconProps) => (
    <svg width='296' height='298' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
        <title id={titleId}>{title}</title>
        <mask id='gemini__a' width='296' height='298' x='0' y='0' maskUnits='userSpaceOnUse'>
            <path
                fill='#3186FF'
