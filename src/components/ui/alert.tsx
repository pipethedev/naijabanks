    ...
    'relative w-full border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground',
    {
        variants: {
            variant: {
                ...
                warning:
                    'border-yellow-400/50 bg-yellow-50 text-yellow-900 dark:border-yellow-900/50 dark:bg-yellow-950 dark:text-yellow-300 [&>svg]:text-yellow-500 dark:[&>svg]:text-yellow-400'
            }
        },
        defaultVariants: {
            variant: 'default'
